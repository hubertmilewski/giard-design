...
<template>
  <section class="w-full bg-bg-base overflow-hidden">
    <div class="mx-auto w-full max-w-360 px-4 py-8 sm:px-6 sm:py-12 lg:px-50 lg:py-15">
      ...
      <div 
        class="w-full bg-primary flex flex-col lg:flex-row items-start sm:items-center justify-center px-6 py-10 sm:px-12 sm:py-14 lg:h-88 lg:gap-x-16 lg:px-0 lg:py-0"
      >
        <!-- Lewa strona -->
